...
CREATE TABLE `securitystaff` (
  `SecurityStaffID` int NOT NULL AUTO_INCREMENT,
  `UserID` int DEFAULT NULL,
  `Shift` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`SecurityStaffID`),
  KEY `UserID` (`UserID`),
  CONSTRAINT `securitystaff_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`)
...
-- Dump completed on 2026-01-09 15:54:47
